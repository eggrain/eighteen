...
export default function Three() {
    return (
        <main className="article-18-page article-18-three-page">
            <article className="article-18-flyer article-18-three">
                <header className="three-header">
                    <div className="three-contract-name">
                        UPS NATIONAL MASTER AGREEMENT
                    </div>

                    <h1>ARTICLE 18</h1>

                    <div className="three-section-name">
                        Section 2 — Out of Service Equipment
                    </div>
                </header>
                ...
                <section className="three-action-section">
                    <div className="three-action-label">
                        STOP AND REPORT
                    </div>
                ...
                <footer className="three-footer">
                    <strong>Article 18, Section 2</strong>
